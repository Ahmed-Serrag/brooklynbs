...
import 'package:clean_one/src/pages/payment_page.dart';
...
class _PaymentDetailPageState extends ConsumerState<PaymentDetailPage> {
  ...
  void initState() {
    super.initState();
    selectedAmount = widget.remainingAmount; // Default to full remaining amount
  }
    ...
    setState(() {
      if (isPartialPayment) {
        ...
        if (enteredAmount != null &&
          ...
          partialAmountController.text = widget.remainingAmount.toString();
        }
      } else {
        selectedAmount = widget.remainingAmount;
      }
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // _buildPaymentDetailRow("Details", "Residential"),
                // _buildPaymentDetailRow("Reference Num", "A06453826151"),
                _buildPaymentDetailRow("Account", user?.name ?? "Unknown"),
                const Divider(thickness: 1, height: 20),

                // Toggle Button (Partial or Full Payment)
                Row(
                  ...
                  Padding(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        filled:
                            true, // Ensures the input field has a white background
                        fillColor:
                            Colors.white, // Explicitly set white background
                      ),
                      onChanged: (value) {
                        _updateSelectedAmount();
                      },
                ...
                _buildPaymentDetailRow("Paid Amount", "£${widget.paidAmount}"),
                _buildPaymentDetailRow(
                    "Remaining Amount", "£${widget.remainingAmount}"),

                // _buildPaymentDetailRow("Final Total", "£${widget.amount}"),
                  ...
                  onPressed: _isProcessingPayment
                      ...
                      : () async {
                          if (user != null) {
                            ...
                            await _pay(user,
                                selectedAmount); // Call `_pay()` (which already handles success/failure)

                            setState(() {
                              _isProcessingPayment =
                                  false; // Hide loader after payment process
                            });
                          } else {
  ...
  Future<Map<String, dynamic>?> _pay(
      final UserModel user, double amount) async {
    try {
